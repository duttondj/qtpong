...
static const char qt_meta_stringdata_Engine[] = {
    "Engine\0\0player\0sendWin(bool)\0finished()\0"
    "moveBall()\0paddle,up\0movePaddle(Paddle*,bool)\0"
};
...
void Engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sendWin((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->finished(); break;
        case 2: _t->moveBall(); break;
        case 3: _t->movePaddle((*reinterpret_cast< Paddle*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    }
}
